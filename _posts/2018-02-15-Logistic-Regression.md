...
대출을 했을 때 파산할 확률에 대한 오즈는 아래와 같다.
$$\frac{P(Y=1|X=1)}{1-P(Y=1|X=1)}$$ = $$\frac{70/100}{30/100}$$ = $$\frac{7}{3}$$ 

그리고 대출을 하지 않았을 때 파산할 확률에 대한 오즈는 아래와 같다.
$$\frac{P(Y=0|X=1)}{1-P(Y=0|X=1)}$$ = $$\frac{40/100}{60/100}$$ = $$\frac{2}{3}$$ 
